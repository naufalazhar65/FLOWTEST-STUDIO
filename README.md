...
- **Next priorities:** Continue M5 governance (per-project AI settings, ambiguity clarification, secret redaction), then M6 collaboration/versioning.
